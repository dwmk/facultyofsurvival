...
const SPRITE_URL = 'https://web.dewanmukto.com/asset/images/geminidrake_deviantart_spritesheet_freeschooluniforms.png';
const ALBEDO_SPRITE_URL = 'https://web.dewanmukto.com/asset/images/geminidrake_deviantart_spritesheet_albedo.png';
const SUPPORTS_SPRITE_URL = 'https://web.dewanmukto.com/asset/images/geminidrake_deviantart_spritesheet_supports.png';
...
const drawChatBubble = (
  ...
  ctx.restore();
    ...
    if (playerUpgrades.chatGPTTrackers > 0) {
      ...
      const img = new Image();
      img.src = 'https://web.dewanmukto.com/asset/images/gpticon.png';
