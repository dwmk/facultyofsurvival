      ...
      <div className="text-white text-center max-w-2xl px-8">
        ...
        <div className="bg-gray-800 p-6 rounded-lg mb-8 text-left space-y-3">
          ...
          <div className="space-y-2">
            ...
            <p><span className="text-yellow-400 font-bold">Objective:</span> Avoid students and collect coins</p>
            <p><span className="text-red-400 font-bold">Danger:</span> Students will chase you and drain your health</p>
